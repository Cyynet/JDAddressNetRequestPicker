...
- (void)initContentScroll{
    ...
    self.proviceTable = [[TXLAddressPickTableView alloc] init];
    ...
    self.proviceTable.addressPickBlock = ^(TXLAddrObject *object){
        if(![object.addrId isEqualToString:weakSelf.address.provinceId]){
            weakSelf.address = [[TXLAddress alloc] init];
    ...
    self.cityTable = [[TXLAddressPickTableView alloc] init];
    ...
    self.cityTable.addressPickBlock = ^(TXLAddrObject *object){
    ...
    self.districtTable = [[TXLAddressPickTableView alloc] init];
    ...
    self.districtTable.addressPickBlock = ^(TXLAddrObject *object){
        //确认选择
